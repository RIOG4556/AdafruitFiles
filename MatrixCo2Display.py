...
color[4] = 0x0000FF  #blueish
color[5] = 0x351C75  #Dark Purple
color[6] = 0X20124D  #superdark
color[7] = 0x4C1130  #Evendarker
...
def update_time(*, hours=None, minutes=None, show_colon=False):
    ...
    if hours >= 18 or hours < 6:  # evening hours to morning
        clock_label.color = color[5]
    else:
        clock_label.color = color[4]  # daylight hours
